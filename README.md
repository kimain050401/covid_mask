...
## 파일 설명
* **project-2.tm** : https://teachablemachine.withgoogle.com/train/image 에서 파일 업로드로 사전에 모델링한 파일 오픈
* **keras_model.h5** : 위 "project-2.tm"를 내보낸 모델 파일
...
* [2020.11.21.] 수정된 코드 "face_scan_cam_code.py"로 커밋 완료. dlib 라이브러리 사용 안함. 얼굴인식 시 사진 촬영 후 저장(코스크, 턱스크, 노스크 검출).
## 교내 단속 예정 구역
